...
class BaseModel extends Model
{
       ...
       public function generateSlug($string = false, $count = 0)
    {
        ...
        // Step 1: Replace spaces/special chars with '-', but preserve '/'
        $slug = $this->strToSlugWithSlashes($string);

        // Step 2: Append count if needed
        ...
        // Step 4: Recursively generate unique slug if duplicate exists
        if (!empty($check)) {
    ...
    /**
     * Custom slug helper that preserves forward slashes (/).
     */
    protected function strToSlugWithSlashes($string)
    {
        // Replace spaces and special chars (except '/') with '-'
        $string = preg_replace('/[^\p{L}\p{N}\/-]+/u', '-', $string);
        
        // Trim trailing hyphens and slashes
        $string = trim($string, '-/');
...
//    }
    ...
    public function translation(){
        return $this->hasOne($this->getTranslationModelNameDefault(),'origin_id')->where('locale',request()->input('lang',app()->getLocale()));
    }
