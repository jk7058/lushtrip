<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="">
                <input type="text" name="short_desc" class="form-control" value="{{$translation->short_desc}}">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label">{{__("Desclaimer")}}</label>
            <div class="">
                <textarea name="desclaimer" class="form-control" cols="30" rows="4">{{$row->desclaimer}}</textarea>
            </div>
        </div>
        @if(is_default_lang())
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label">{{__("Tour rating standard")}}</label>
                <input type="number" name="star_rate" class="form-control" value="{{$row->star_rate}}" placeholder="{{__("Eg : 5")}}">
            </div>
            <div class="form-group">
