...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function doCheckout(Request $request)
    {
        ...
        if (!empty($rules)) {
            ...
            $messages['passengers.*.first_name.required'] = 'The first name for each passenger is required.';
            $messages['passengers.*.last_name.required'] = 'The last name for each passenger is required.';
            $messages['passengers.*.gender.required'] = 'The gender for each passenger is required.';
        ...
        // Normal Checkout
        $booking->first_name = $request->input('passengers')[1]['first_name'];
        $booking->last_name = $request->input('passengers')[1]['last_name'];
        ...
        $booking->zip_code = $request->input('passengers')[1]['zip_code'];
        $booking->country = $request->input('passengers')[1]['country'];
        ...
        // VD:29052023 - Add ref number
        $refnumber = '#LTS'.Str::random(12);
        $booking->reference_id = $refnumber;
