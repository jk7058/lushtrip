<div class="card w-100 shadow-hover-3 mb-5">
	...
	<div class="card-body px-3 pt-0 pb-3 my-0 mx-1">
		<div class="row">
			<div class="col-7">
				<a href="#" class="card-title text-dark font-size-17 font-weight-bold" tabindex="0">{{$row->title}}</a>
			</div>
			<div class="col-5">
			...
			<div class="px-3">
				<div class="d-flex mx-1">
					...
					<div class="d-flex flex-column">
						...
						<span class="font-size-14 text-gray-1">{{\Carbon\Carbon::parse($row->departure_time)->format("D M d H:i A")}}</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="px-3">
				<div class="d-flex mx-1">
					...
					<div class="d-flex flex-column">
						...
						<span class="font-size-14 text-gray-1">{{\Carbon\Carbon::parse($row->arrival_time)->format("D M d H:i A")}}</span>
					</div>
				</div>
			</div>
		</div>
