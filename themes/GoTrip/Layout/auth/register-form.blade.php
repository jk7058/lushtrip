<form action="#" class="form bravo-form-register" method="post">
    ...
    <div class="row y-gap-20">
        <div class="col-12">
            ...
            <p class="mt-10">{{ __('Already have an account?') }} <a href="{{ route('login') }}" class="text-blue-1">{{ __('Log in') }}</a></p>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="d-flex">
                ...
                <div class="text-15 lh-15 text-light-1 ml-10">{{ __('I have read and accept the Terms and Privacy Policy?') }}</div>
            </div>
        </div>
