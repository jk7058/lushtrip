        ...
        <div data-anim-child="slide-up delay-2" class="tabs -pills-2 pt-40 js-tabs">
            <div class="tabs__controls row x-gap-15 justify-center js-tabs-controls">
                @foreach($locations as $k=>$location)
                    ...
                    <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button @if($k==0) is-tab-el-active @endif" data-tab-target=".-tab-{{$location->slug}}">{{ $translation->name }}</button>
                    </div>
                @endforeach
            </div>
