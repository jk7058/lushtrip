<div class="form-checkout" id="form-checkout">
    ...
    <div class="mb-5 shadow-soft bg-white rounded-sm">
        <div class="pt-4 pb-5 px-5">
            ...
            <div class="row">
                <div class="col-sm-12 mb-4" style="color:green;font-weight:bold;">User Details</div>
                @if(Session::get('service_type') == 'flight' && Session::get('total_passengers_count')>1)
                    @for ($i = 1 ; $i <= (Session::get('total_passengers_count')-1); $i++)
                        <div class="col-sm-6 mb-2">
                            <label class="form-label">{{ __("First Name") }}</label>
                            <input type="text" placeholder="{{__("First Name")}}" class="form-control" name="passengers[{{$i}}][first_name]">
                        </div>
                        <div class="col-sm-6 mb-2">
                            <label class="form-label">{{ __("Last name") }}</label>
                            <input type="text" placeholder="{{__("Last Name")}}" class="form-control" name="passengers[{{$i}}][last_name]">
                        </div>
                    @endfor
                @endif
                ...
                <!-- <div class="col-sm-6 mb-4">
                    ...
                    <input type="text" placeholder="{{__("First Name")}}" class="form-control" value="" name="first_name">
                </div>
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        {{ __("Last name") }}
                    </label>
                    <input type="text" placeholder="{{__("Last Name")}}" class="form-control" value="" name="last_name">
                </div> -->
                <div class="col-sm-6 mb-4">
                    <label class="form-label">
                        {{ __("Email") }}
                ...
                <div class="col-sm-12 mb-4">
                    ...
                    <button class="btn btn-primary w-100 rounded-sm transition-3d-hover font-size-16 font-weight-bold py-3" id="confirm_booking" @click="doCheckout">{{__('CONFIRM BOOKING')}}
