    ...
    <form action="{{route('tour.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ').$row->title." - ".$row->reference_code : __('Add new tour')}}</h1>
                    @if($row->slug)
            ...
            <div class="lang-content-box">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                        <div class="panel">
                            <div class="panel-title"><strong>{{__('Remark')}}</strong></div>
                            <div class="panel-body">
                                @if(is_default_lang())
                                    <div>
                                        <label>
                                            <textarea name="remark"  class="form-control full-h"  cols="35" rows="5"><?php echo $row->remark; ?></textarea>
                                        </label>
                                    </div>
                                @endif
                            </div>
