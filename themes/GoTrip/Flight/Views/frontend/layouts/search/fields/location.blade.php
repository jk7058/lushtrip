...
<div class="searchMenu-loc px-30 lg:py-20 lg:px-0 js-form-dd js-liverSearch">
    <div data-x-dd-click="searchMenu-loc">
        ...
        <div class="text-15 text-light-1 ls-2 lh-16">
            ...
            <input autocomplete="off" type="search" placeholder="{{ ($inputName != 'location_id') ? __('City or airport') : __('Where are you going?') }}" class="js-search js-dd-focus" value="{{ $location_name ?? '' }}" />
        </div>
    </div>
