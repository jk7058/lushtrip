<tr>
    ...
    <td width="2%">
        ...
        <a href="{{route('vendor.booking_report.reply',['booking'=>$booking->id])}}" class="btn btn-xs btn-primary btn-info-booking open-new-window mt-1" onclick="window.open(this.href); return false;">
