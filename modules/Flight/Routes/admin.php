...
// VD:30072023 - Add flight timings route
Route::get('/flight-timings/{id}','FlightController@flightTimings')->name('flight.admin.flight.timings');
Route::post('flight-timings/bulkUpload','FlightController@flightTimingsBulkUpload')->name('flight.admin.flight.timings.bulkUpload');
Route::post('/flight-timings/update','FlightController@UpdateflightTimings')->name('flight.admin.flight.timings.update');
