										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
													...
													<!-- VD:30072023 - Add Bulk upload button -->
													<a href="{{route('flight.admin.flight.timings',['id'=>$row->id])}}" class="dropdown-item btn btn-primary "><i class="fa fa-edit"></i> {{__('Flight Timings')}}</a>
												</div>
											</div>
										</td>
									</tr>
